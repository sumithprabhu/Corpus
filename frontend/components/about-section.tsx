          ...
          <div className="flex-1 flex flex-col justify-between px-5 py-6 lg:py-8">
            <div className="flex flex-col gap-6">
              ...
              >
                Datasets and models,
                <br />
                <span className="text-[#ea580c]">proven on-chain</span>
              </motion.h2>
              ...
              >
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Corpus stores your datasets on Filecoin via Synapse. Upload,
                  version, and retrieve with optional encryption. Treasury-backed
                  payments: deposit USDFC, pay per upload and per month. Provenance
                  hashes anchored on-chain for reproducibility.
                </p>
                <p className="text-xs lg:text-sm font-mono text-muted-foreground leading-relaxed">
                  Get an API key from the dashboard, use the SDK or REST API to
                  upload and list datasets, register model runs, and keep your
                  pipeline auditable.
                </p>
              </motion.div>
